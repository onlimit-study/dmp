...
## Storage of the ON LiMiT research data and metadata

There are three main places for storage of data for the ON LiMiT
project. The first two, where the data is generated are REDCap and the
...
possible without any significant loss of data. REDCap is also 'out of
our hands' so to speak, as the setup is done entirely without any user
engagement.
...
section on Sharing Data) we don't expect to be backing up any analysis
