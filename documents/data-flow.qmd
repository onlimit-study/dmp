...
Watch@{shape: proc, label: "<b>Withings Watch</b><br> smart watch which will connect to the Liva app."}
Scales@{shape: proc, label: "<b>Withings Scales</b><br> smart scales which will connect to the Liva app."}
