...
onlimit@{shape: proc, label: "<b>ON LiMiT</b><br><i>[system]</i><br><br>needs description, preferably something long-ish which will result in the box being larger than the rest of them. "}
