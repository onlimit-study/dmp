...
Has the project been reported to AU's record? (*Please tick relevant box*)
...
## 2 Information about the research project:
<!--TODO Complete fields in section 2-->
Title of the research project: ON LiMiT

Purpose of the research project: Remission of T2D using diet and
exercise

Start date of the research project: Jan 2026

## 3 Information about personal data, categories of data subjects and legal basis for processing

_**What types of personal data will be processed in the project:**_

General personal data (name, dob, contact information, etc).

Sensitive personal data (health data)

Confidential personal data (cpr)
